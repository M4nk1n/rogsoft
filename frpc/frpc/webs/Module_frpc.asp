                                        ...
                                        <tr id="switch_tr">
                                            ...
                                            <td colspan="2">
                                                ...
                                                <div id="frpc_changelog_show" style="padding-top:5px;margin-right:10px;margin-top:0px;float: right;">
                                                    <a type="button" class="frpc_btn" style="cursor:pointer" href="https://github.com/M4nk1n/rogsoft/blob/main/frpc/Changelog.txt" target="_blank">更新日志</a> <a type="button" class="frpc_btn" style="cursor:pointer" target="_blank" href="https://github.com/fatedier/frp/blob/master/README_zh.md">自定义配置帮助</a>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr id="frpc_status">
